...
<body>
<div class="container" style="margin-top: 6%; border:1px solid #d8d8d8; padding: 30px; border-radius: 5px;">
    <h1>ORDER STATUS</h1>
    <div class="col-12">
        <?php if(!empty($orderInfo)){ ?>
            ...
            <div class="row col-lg-12 ord-addr-info">
                <div class="hdr">
                    <h4 style="color: #208898; font-style: italic;">Order Info</h4>
                </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h5 style="float:right;padding: 10px; color: #208898;"><a href="index.php" style="text-decoration: none;">Back to Home</a></h5>
        </div>
    </div>
</div>
</body>
